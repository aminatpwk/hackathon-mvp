                ...
                <div style={modalStyles.overlay} onClick={() => setShowModal(false)}>
                    <div style={modalStyles.modal} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div style={modalStyles.formGroup}>
                            <label style={modalStyles.formLabel}>Sasia</label>
                            <input id="quantity" type="number" min="1" defaultValue="1" style={modalStyles.formInput}/>
                        </div>

                        <div style={modalStyles.formGroup}>
                            <label style={modalStyles.formLabel}>Mesazh (opsional)</label>
                            <textarea id="message" style={modalStyles.formTextarea} placeholder="Shënoni kërkesa të veçanta ose pyetje për fermerin..."/>
                        </div>
